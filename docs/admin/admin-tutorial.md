...
Вносимо всі дані про заклад: **Профіль** > **Олівець** на зеленому фоні (розділ інформації про ваш заклад в режимі редагування) > Заповнюємо відповідні поля інформації, посилання на соцмережі, контакти > **"Зберегти"**.
...
![settings_new](./img/settings_new.png)
...
- **Приховати баланс гуртків** - Приховуємо стан балансу, реквізити для оплати по гурткам у батьків? Приховуємо - вмикаємо (помаранчевий), показуємо - вимикаємо (сірий).
- **Приховати баланс послуг** - Приховуємо стан балансу, реквізити по основним послугам у батьків? Приховуємо - вмикаємо (помаранчевий), показуємо - вимикаємо (сірий).
- **Приховати баланс харчування** - Приховуємо стан балансу, реквізити по розділу харчування у батьків? Приховуємо - вмикаємо (помаранчевий), показуємо - вимикаємо (сірий).
- **Приховати в призначенні платежу номер договору** - Приховуємо номер договору дитини в рахунках? Приховуємо - вмикаємо (помаранчевий), показуємо - вимикаємо (сірий).

### Працівники

Формуємо список команди закладу.

- **Профіль** > **Працівники** > **"Додати працівника”** (кнопка доступна при умові пустого списку) або натискаємо **"+"** у верхньому правому куті > Вносимо імʼя, прізвище, основний номер телефону, дата народження > **“Додати”**
...
### **Інструкція для батьків по підключенню до аккаунту дитини інших відповідальних осіб** 
...
- **Додаткові контакти** - тут вносимо контактні дані додаткових відповідальних осіб. УВАГА! Це інформативні номери, вхід в аккаунт дитини здійснюється тільки по основному номеру!

![additional_person](./img/additional_person.png)
...
![group2](./img/group2.png) ![group](./img/group.png)
...
:::warning ВАЖЛИВО
В полі "Призначення платежу (для рахунків)" **пишемо лише ПОЧАТОК** назви послуги, **система сама “допише”** в кожний рахунок імʼя та прізвище дитини, номер рахунку та оплатний період!
:::
...
В профілі дитини на кожній підключеній до дитини послузі, гуртку буде відображатися картка 💳. Натискаючи на картку батьки бачитимуть список реквізитів:

![card](./img/card.png)
![card2](./img/card2.png)

Також ці реквізити будуть вказуватися в рахунках, які будуть виставлені адміністратором закладу.

### Харчування
Розділ для **обліку харчування**, який можна налаштувати як по окремому прийому їжі, так і за день. 

- Розділ табелювання (відміток присутності) харчування по окремим прийомам їжі:

![eat_separet](./img/eat_separet.png)

- Розділ табелювання (відміток присутності) харчування за день:

![eat_all](./img/eat_all.png)

#### Процес налаштування обліку харчування:
1. Вносимо прийоми їжі: Профіль > **Харчування** > **іконка "приборів їжі"** в правому верхньому куті > **"+"** у верхньому правому куті > назва, ціна, порядковий номер (автоматично) > **Додати**

![eat_all](./img/eat_all.png) ![eat_menu](./img/eat_menu.png) ![add_menu](./img/add_menu.png)

2. Приєднуємо способи оплати: Профіль > **Харчування** > **іконка "приборів їжі"** в правому верхньому куті > **"картка"** у верхньому правому куті > обираємо зі списку доступних способів оплат (реквізитів)

![add_pay_eating](./img/add_pay_eating.png)

3. Вносимо прийом їжі в розклад відповідної групи: Профіль > **Групи** > Обираємо групу > **Розклад** > обираємо чи вносимо (якщо ще не сформований розклад) прийом їжі > обовʼязково вказуємо тип "харчування" > обираємо зі списку шаблонів прийомів їжі

![add_in_shcedule](./img/add_in_shcedule.png) ![add_in_shcedule_2](./img/add_in_shcedule_2.png)

Після пройдених кроків в розділі "Харчування" відобразиться список прийомів їжі груп зі списками діток.

#### Облік харчування (відмітки)

Профіль > **Харчування** > обираємо групу > обираємо день на календарі > відкриваємо прийом їжі > ставимо галочку присутності ✅

:::info Автоматичні нарахування
Кожна галочка ✅ конвертується в нарахування дитині в її профіль, саме в окремий розділ "харчування". 
Для перевірки заходимо в розділ "Діти", профіль окремої дитини та відкриваємо "харчування"
:::

**Де переглянути звіт по харчуванню?**

Профіль > **Харчування** > **іконка "таблички"** в правому верхньому куті

![zvit_eating](./img/zvit_eating.png)

### Рахунки

Виставлення рахунків по основним та додатковим послугам, харчуванню.
...
- Генеруємо рахунки: Профіль > Рахунки > **Сформувати рахунки** або **+** (у верхньому меню) > Обираємо період, послуги > "**Сформувати**"
![payments_1](./img/payments_1.png)

- **Перевіряємо “Чернетки”** на правильність сум, реквізитів та коментарів в рахунках.

:::danger
В разі виявлення **помилок** - **Редагуємо рахунок** (кнопка внизу поруч з "Опублікувати"). Також рекомендовано внести коригування у баланс дитини.
:::

- Натискаємо **“Опублікувати”**. Після цього рахунки перейдуть у вкладку “До сплати”, прийде сповіщення батьків про нові рахунки, відобразяться у батьків та профілях дітей.

Покроково в картинках:

![payments_2](./img/payments_2.png) ![payments_3](./img/payments_3.png) ![payments_4](./img/payments_4.png) ![payments_5](./img/payments_5.png)
...
![add_pay](./img/add_pay.png)

:::danger Як редагувати опублікований рахунок?
Якщо потрібно внести коригування в уже опублікований рахунок батькам: заходимо в рахунок, натискаємо **"Зробити чернеткою"**, вносимо коригування в чернетці рахунку та знову **"Опублікувати"**.
:::

:::tip Нагадати батькам про несплачені рахунки
В списку рахунків "До сплати" є опція повторного нагадування про рахунки батькам. Натискаємо **"Нагадати про оплату"**, обираємо батьків зі списку, додаємо текст повідомлення та натискаємо **"Надіслати нагадування"**. В цей момент у них повторно прийде push-повідомлення в застосунку.
:::

:::info
**"Чернетки"** - це **для внутрішньої перевірки**, доступні лише адміністратору закладу.  
**"До сплати"** - **доступні батькам** в профілі дитини.  
**"Сплачені"** - доступні і батькам, і адміністратору для перегляду.
:::
...
### Кнопка "ОПЛАТИТИ" у рахунку батьків
Підключення кнопки "Оплатити" в рахунки батьків. 
Виглядатиме вона так: 

![knopka_oplata_2](./img/knopka_oplata_2.png)

Підключення кнопки: Профіль > **Реквізити** > Обираємо потрібний спосіб оплати > "..." > Редагувати > **Активувати оплату рахунків (Mono)** > **Написати в підтримку Sadok**

![knopka_oplata](./img/knopka_oplata.png)
![knopka_oplata_1](./img/knopka_oplata_1.png)

Менеджер Sadok проконсультує про процес підключення.
...
#### Планова відсутність дитини (попередження від батьків)
...
:::warning Обовʼязково підтверджуйте відсутність
Попередження, яке виділене червоним кольором в списку дітей групи, потребує підтвердження відсутності ❌ вихователем чи адміністратором закладу.
:::


### Гуртки та додаткові послуги
...
- Додаємо новий гурток: Головна (чи в Профілі) > Гуртки > **"Проведено"** чи "Поточні" > **“+”** у верхньому меню > Вносимо назву гуртка > **“Додати”**
...
Коли діти розподілені по гурткам, їх баланси відображаються в профілях та інформації гуртка. Тож можемо налаштувати формат відвідування:

#### Абонементи щомісячні (з автопродовженням)
- Вмикаємо щомісячний абонемент: Гурток > **Дитина** (обираємо внизу зі списку відвідувачів гуртка) > **Активуємо кнопку “Абонемент"** > **"Підключити"**

:::info
**Вартість абонементу** вказана **в описі гуртка**. Саме її **щомісяця (кожного 1-го числа) система автоматично нараховуватиме** в баланс дитини.
:::

![dop_serv4](./img/dop_serv4.png)
![dop_serv5](./img/dop_serv5.png)
![dop_serv6](./img/dop_serv6.png)
![abonka_1](./img/abonka_1.png)

#### Абонементи разові (по кількості занять та до фіксованої дати)

- Вмикаємо разовий абонемент: Гурток > **Дитина** (обираємо внизу зі списку відвідувачів гуртка) > **Активуємо кнопку “Абонемент"** > **"Інше"** > Активуємо необхідний **формат** (кінцева дата чи кількість занять) > вносимо **вартість** абонементу > **"Зберегти"**

:::info Вказана вартість одразу нарахується
Після збереження налаштованого абонементу в балансі дитини відбудеться нарахування вказаної вартості, тобто одразу зʼявиться "мінус".
:::
...
![dop_serv6](./img/dop_serv6.png)
![abonka_1](./img/abonka_1.png)
![abonka_2](./img/abonka_2.png)

#### Баланс дитини по гуртку 
- Гурток > **Дитина** (внизу зі списку відвідувачів гуртка) > **“+”** зверху > Обираємо тип **“Внести кошти / Нарахувати / Коригування”**
...
:::success
В цей момент в баланс дитини буде **нараховано вартість разового заняття**, якщо не увімкнено абонемент. Якщо у дитини абонемент, то просто **зберігається статистика** її відвідуваності, що відображається і у батьків, чи відмінусовується заняття з доступних (разові абонементи).
:::
...
#### Заявки від батьків
Батьки мають змогу залишати заявки на підключення гуртка. Якщо заявка батьків не підтверджена адміністратором, то в списку табелювання дитина буде відображатися так:
...
У адміністратора ця інформація приходить в розділ "Нових заявок". Відкриваємо заявку та **"Підтверджуємо"** чи **"Скасовуємо**" її.
...
- Копіювання новин: **Головна** > **Новини** > **Обираємо новину** > **"Копіювати"** в правому верхньому куті > **Редагуємо** зміст новини (за потреби).
...
:::success
Інформація про подію з детальним описом **відображається у батьків на головній до самої дати події**.
:::
...
- Створюємо подію: **Головна** > **Події** > Обираємо цільову аудиторію, кому транслюємо інформацію: **заклад** (на зеленому фоні) **чи** окрему **групу** > **"+"** у верхньому правому куті > Додати головне фото, заголовок, текст, дата (обовʼязково) та час (не обовʼязково) > **"Додати подію"**
...
![chatss](./img/chatss.png)

Щоб переглянути **групові, гурткові чати та особисті "вихователі-батьки"** - натискаєм на іконки додаткових чатів у верхньому меню:

![chat1](./img/chat1.png)
![chat_group](./img/chat_group.png)
![chatsss](./img/chatsss.png)
...
- **Звіт по харчуванню**: Профіль > **Харчування** > **іконка "таблички"** в правому верхньому куті
...
Тож будемо вдячні за ідеї 💡 та побажання - їх можна залишити за посиланням: [скарбничка побажань та ідей](https://forms.gle/MzizKM3HqmCcetjH7)