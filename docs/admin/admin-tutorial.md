...
#### Кнопка "ОПЛАТИТИ" у рахунках батьків
Щоб підключити кнопку "оплатити" в рахунку батьків, потрібно підключити до реквізитів еквайринг від банку. 
Як виглядатиме та де розміщена у профілі батьків?

![counts_21](./img/counts_21.png)

**Як підключити кнопку "оплатити"?**

Профіль > **Реквізити** > Обираємо необідний шаблон реквізитів > **...** > Редагувати > **"Активувати оплату рахунків (Mono)"** > Зробити кроки по іннструкції інформаційного вікна

![Set_paymant](./img/Set_paymant.png) ![Set_paymant_1](./img/Set_paymant_1.png)
