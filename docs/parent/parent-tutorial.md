...
:::warning
Результати голосувань відображаються у **адміністратора** закладу, та у вихователів в разі дозволу від адміністратора.
:::
...
### Попередження про відсутність дитини
...
- Груповий (опціонально)
- Особистий з вихователями (опціонально)
- Чати по окремим студіям, гурткам (опціонально)

![chats-2](./img/chats-2.png)

:::info
Цей розділ **налаштовується під заклад**, тож деякі з вказаних видів чатів **можуть бути вимкнені**, в такому разі вони не будуть відображатися.
:::
...
:::success
Після налаштування, **з наступного завантаження** медіа файлів ШІ-фільтр почне працювати.
:::

## Профіль

Особливості дитини, відповідальна особа, додаткові контактні дані, повна інформація про гуртки та послуги дитини з фінансами, звітами присутності, реквізити для оплати, документами та рахунками.
...
Адміністратор закладу формує та публікує рахунки по дитині. 
В рахунку буде відображено:

- Повний перелік послуг
- Вартість
- Оплатний період
- Реквізити для оплати
- **Автоматично сформоване призначення платежу** для призначення платежу
- Тип рахунку

![counts_profile](./img/counts_profile.png) ![counts_2](./img/counts_2.png)

:::info
Тип рахунку **До сплати** свідчить, що оплата досі **очікується**, **сплачено** - сплачений рахунок, внесені кошти в баланс.
:::
